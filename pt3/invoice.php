...
?>
    ...
    try {
      ...
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_a161180, tbl_staffs_a161180_pt2,
        tbl_customers_a161180_pt2, tbl_orders_details_a161180 WHERE
        ...
        tbl_orders_a161180.fld_order_num = tbl_orders_details_a161180.fld_order_num AND
        tbl_orders_a161180.fld_order_num = :oid");
...
<div class="col-xs-6 text-center">
  <br>
    <img src="ball2.jpg" width="60%" height="60%">
</div>
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Football House Sdn. Bhd.</h4>
      </div>
      <div class="panel-body">
        <p>
        Jalan Hutan Lipur <br>
        Pulau Kinabatangan<br>
        53300 Kundasang <br>
        Sabah <br>
        </p>
      </div>
    ...
    <div class="col-xs-5 col-xs-offset-2 text-right">
        <div class="panel panel-default">
            <div class="panel-heading">
              <h4>To : <?php echo $readrow['CUSTOMER_NAME']." ".$readrow['CUSTOMER_LASTNAME'] ?></h4>
            </div>
            <div class="panel-body">
        <p>
        13 Street, Big Fo Hallway <br>
        Jojo Asap Kuntung <br>
        Plug Walk Skrrt <br>
        Amsterdam <br>
        </p>
            </div>
  ...
  <div class="col-xs-7">
    <div class="span7">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <p> Staff: <?php echo $readrow['STAFF_NAME']." ".$readrow['STAFF_LASTNAME'] ?> </p>
          <p> Email: <?php echo $readrow['STAFF_EMAIL'] ?> </p>
          <p><br></p>
          <p><br></p>
